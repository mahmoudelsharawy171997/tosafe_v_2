...
import 'trainingReport.dart';
class CreateTrainingReport extends StatefulWidget {
  @override
  _CreateTrainingReportState createState() => _CreateTrainingReportState();
}

class _CreateTrainingReportState extends State<CreateTrainingReport> {
  @override
  void initState() {
    super.initState();
    ...
    return MaterialApp(
      home: Scaffold(
        ...
        body: Container(
          ...
          child: ListView(
            children: [
              Text('Create Training Report',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 30),),
              Container(
              ...
              bottomFlatButton(title: 'Create',color: mainColor,onpress: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => trainingReport()),
                );
              },),
            ],
          ),
