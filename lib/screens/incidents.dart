...
import 'createIncidentsReport.dart';
                ...
                children: [
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Image.asset('images/noun_adhesive bandage.png',),
                        Expanded(
                          child: Container(
                            margin: EdgeInsets.only(left: 10),
                            alignment: Alignment.topLeft,
                            child: Text('Incidents',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 30),),
                          ),
                        ),
                        FlatButton(
                          onPressed: (){
              ...
              Positioned(
                ...
                child: FloatingActionButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => createIncidentsReport()),
                    );
                  },
