...
import 'createFirstAid Report.dart';
                ...
                children: [
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Image.asset('images/noun_first aid kit.png',),
                        Expanded(
                          child: Container(
                            margin: EdgeInsets.only(left: 10),
                            alignment: Alignment.topLeft,
                            child: Text('First Aid',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 30),),
                          ),
                        ),
                        FlatButton(
                          onPressed: (){
              ...
              Positioned(
                ...
                child: FloatingActionButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => createFirstAidReport()),
                    );
                  },
