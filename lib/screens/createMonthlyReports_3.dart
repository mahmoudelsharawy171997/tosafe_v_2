...
class createMonthlyReports_3 extends StatefulWidget {
  @override
  _createMonthlyReports_3State createState() => _createMonthlyReports_3State();
}

class _createMonthlyReports_3State extends State<createMonthlyReports_3> {
  @override
      ...
      home: Scaffold(
        ...
        body: ListView(
          children: [
            ...
            Group2(
              counter: 1,
              groupTitle: 'Housekeeping (inside - outside)',
              subTitles: ['Inside','Outside','Title of pic'],
            ),
            Container(
              margin: EdgeInsets.only(right: 20,left: 20,top: 10),
              child: bottomFlatButton(title: 'Create',color: mainColor,onpress: () {
                Navigator.push(
                  context,
