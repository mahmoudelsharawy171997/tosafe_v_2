...
import 'createRiskReport_Finally.dart';
import 'package:tosafe_v_2/globalElements.dart';
import 'package:tosafe_v_2/widgets/notifiedAppBar.dart';

class createRiskReport_4 extends StatefulWidget {
  @override
  _createRiskReport_4State createState() => _createRiskReport_4State();
}

class _createRiskReport_4State extends State<createRiskReport_4> {
  bool check_1 = false;
  bool check_2 = false;
  @override
              ...
              child: ListView(
                children: [
                  ...
                  bottomFlatButton(title: 'Next',color: mainColor,onpress: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => createRiskReport_Finally()),
                    );
                  },),
                ],
              ),
