...
import 'createRiskReport_4.dart';
import 'package:tosafe_v_2/globalElements.dart';
import 'package:tosafe_v_2/widgets/notifiedAppBar.dart';

class createRiskReport_3 extends StatefulWidget {
  @override
  _createRiskReport_3State createState() => _createRiskReport_3State();
}

class _createRiskReport_3State extends State<createRiskReport_3> {
  bool check_1 = false;
  bool check_2 = false;
  @override
              ...
              child: ListView(
                children: [
                  ...
                  bottomFlatButton(title: 'Next',color: mainColor,onpress: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => createRiskReport_4()),
                    );
                  },),
                ],
              ),
