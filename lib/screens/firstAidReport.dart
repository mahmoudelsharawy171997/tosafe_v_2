...
class firstAidReport extends StatefulWidget {
  @override
  _firstAidReportState createState() => _firstAidReportState();
}
...
class _firstAidReportState extends State<firstAidReport> {
  @override
      ...
      home: Scaffold(
        ...
        body: Container(
          ...
          child: ListView(
            ...
            children: [
              Text('First Aid Report',style: TextStyle(fontSize: 30,fontWeight: FontWeight.bold),),
        ...
        children: [
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              child: Icon(Icons.delete,color: redColor,size: 30,),
            ),
          ),
        ],
      ),
