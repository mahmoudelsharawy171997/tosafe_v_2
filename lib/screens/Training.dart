...
import 'createTrainingReport.dart';
              ...
              Column(
                children: [
                  Container(
                    ...
                    child: Row(
                      children: [
                        Image.asset('images/noun_training.png',),
                        Expanded(
                          child: Container(
                            margin: EdgeInsets.only(left: 10),
                              alignment: Alignment.topLeft,
                              child: Text('Training',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 30),),
                          ),
                        ),
                        FlatButton(
                          onPressed: (){
                                  ...
                                  child: Column(
                                    children: [
                                      Row(
                                        ...
                                        children: [
                                        Image.asset('images/noun_calender_2.png',fit: BoxFit.fitWidth,width: 25,),
                                        Text(
                                          'Duration',
                                          style: TextStyle(
                                              fontSize: 20,
                                        ...
                                        Container(
                                          ...
                                          child: Row(
                                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                            children: [
                                              Image.asset('images/noun_reset.png',fit: BoxFit.fitWidth,width: 15,),
                                              Text(
                                                  ' Reset to defualt',
                                                style: TextStyle(
                                                    fontSize: 16,
                                      ...
                                      Container(
                                        ...
                                        child: ListView(
                                          children: [
                                            ...
                                            calendar(calendarController: _calendarController),
                                            bottomFlatButton(title: 'Apply',color: mainColor,onpress: (){},),
                                          ],
                                        ),
                                      )
                                    ],
              ...
              Positioned(
                ...
                child: FloatingActionButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => CreateTrainingReport()),
                    );
                  },
