...
class createFirstAidReport extends StatefulWidget {
  @override
  _createFirstAidReportState createState() => _createFirstAidReportState();
}

class _createFirstAidReportState extends State<createFirstAidReport> {
  @override
  void initState() {
    super.initState();
    ...
    return MaterialApp(
      home: Scaffold(
        ...
        body: Container(
          ...
          child: ListView(
            children: [
              Text('Create First Aid Report',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 30),),
              Container(
              ...
              bottomFlatButton(title: 'Create',color: mainColor,onpress: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => firstAidReport()),
                );
              },),
            ],
          ),
