...
class trainingReport extends StatefulWidget {
  @override
  _trainingReportState createState() => _trainingReportState();
}
...
class _trainingReportState extends State<trainingReport> {
  @override
      ...
      home: Scaffold(
        ...
        body: Container(
          ...
          child: ListView(
            ...
            children: [
              Text('Training report',style: TextStyle(fontSize: 30,fontWeight: FontWeight.bold),),
